...
class TestEmployeeSalaryService(unittest.TestCase):
    ...
    def setUp(self):
        self.client = Mock()
        self.salary_service = EmployeeSalaryService(self.client)
        self.mock_auth_header = Mock()
        self.salary_service.set_auth_header(self.mock_auth_header)
    ...
    def test_get_all_by_company(self):
        ...
        self.assertEqual(salary_1.star_date, "2023-01-01")
        ...
        self.assertEqual(salary_2.star_date, "2023-01-01")
