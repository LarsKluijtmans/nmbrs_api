...
class TestEmployeeChildService(unittest.TestCase):
    ...
    def test_get(self):
        ...
        self.client.service.Children_Get.return_value = {
            "EmployeeChildren": {"Child": [{"Id": 1, "Name": "Alice", "FirstName": "Alice", "Initials": "A", "Gender": "Female", "Birthday": datetime(2010, 1, 1)}]},
    ...
    def test_get_all_by_company(self):
        ...
        self.client.service.Children_GetAll_Employeesbycompany.return_value = [
            {"EmployeeChildren": {"Child": [{"Id": 1, "Name": "Alice", "FirstName": "Alice", "Initials": "A", "Gender": "Female", "Birthday": datetime(2010, 1, 1)}]}, "EmployeeId": 123},
            {"EmployeeChildren": {"Child": [{"Id": 2, "Name": "Bob", "FirstName": "Bob", "Initials": "B", "Gender": "Male", "Birthday": datetime(2012, 2, 2)}]}, "EmployeeId": 456}
        ]
        ...
        self.client.service.Children_GetAll_Employeesbycompany.assert_called_once_with(CompanyId=company_id, _soapheaders=self.mock_auth_header)
    ...
    def test_delete(self):
        ...
        self.client.service.Child_Delete.assert_called_once_with(EmployeeId=employee_id, ChildId=child_id, _soapheaders=self.mock_auth_header)
    ...
    def test_insert(self):
        ...
        self.client.service.Children_Insert.assert_called_once_with(EmployeeId=employee_id, child=_child, _soapheaders=self.mock_auth_header)
    ...
    def test_insert_batch(self):
        ...
        self.client.service.Children_InsertBatch.assert_called_once_with(EmployeeId=employee_id, children=_children, _soapheaders=self.mock_auth_header)
    ...
    def test_update(self):
        ...
        self.client.service.Children_Update.assert_called_once_with(EmployeeId=employee_id, child=_child, _soapheaders=self.mock_auth_header)
