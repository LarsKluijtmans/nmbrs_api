...
class NmbrsBaseException(Exception):
    ...
    def get_error(self):
        ...
        match self.error_code:
            case 1000:
                self.name = "Invalid combination email/password"
            ...
            case 1004:
                self.name = "Disabled, no valid subscription"
                self.cause = "Disabled, no valid subscription"
                self.solution = ""
            case 1006:
                self.name = "Generic Login Security Failure"
                self.cause = "Unknown"
                self.solution = "Retrying tends to solve the issue."
            case 2001:
                self.name = "Invalid Hour component"
            ...
            case 2002:
                self.name = "Invalid Wage Component"
            ...
            case 2011:
                self.name = "Protected Mode: Cannot Change in the Past"
            ...
            case 2012:
                self.name = "Wage Tax Declaration Already Sent"
                self.cause = "Wage tax declaration already sent"
                self.solution = ""
            case 2013:
                self.name = "Operation Not Possible On Free Trial"
            ...
            case 2017:
                self.name = "Invalid Labour Agreement ID"
            ...
            case 2019:
                self.name = "Task Status Not Available"
            ...
            case 2028:
                self.name = "Start Time Cannot Be After End Time"
            ...
            case 2029:
                self.name = "Time Slots Cannot Overlap"
            ...
            case 2030:
                self.name = "Invalid Set of Values"
            ...
            case 2040:
                self.name = "Provide File Name with an Extension"
